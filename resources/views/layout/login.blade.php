            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <form action="{{route('post-login')}}" method="POST">
                        ...
                        <button type="submit" class="btn btn-default" name="login" value="login">Đăng nhập</button>
                    </form>
                </div><!--/login form-->
            </div>
            <div class="col-sm-1">
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    @if(count($errors->signup)>0)
                        <div class="alert alert-danger">
                            @foreach($errors->signup->all() as $er)
                                {{$er}}
                                <br>
                            @endforeach
                        </div>
                    ...
                    <form action="{{route('post-signup')}}" method="POST">
                        ...
                        <button type="submit" class="btn btn-default" name="signup" value="signup">Đăng ký</button>
                    </form>
                </div><!--/sign up form-->
            </div>
        </div>
